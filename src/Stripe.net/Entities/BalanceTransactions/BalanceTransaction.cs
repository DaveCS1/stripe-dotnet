namespace Stripe
{
    ...
    public class BalanceTransaction : StripeEntity<BalanceTransaction>, IHasId, IHasObject
    {
        ...
        ///  <c>advance</c>
        ///  <c>advance_funding</c>
        ///  <c>anticipation_repayment</c>
        ///  <c>application_fee</c>
        ///  <c>application_fee_refund</c>
        ///  <c>charge</c>
        ///  <c>connect_collection_transfer</c>
        ///  <c>issuing_authorization_hold</c>
        ///  <c>issuing_authorization_release</c>
        ///  <c>issuing_dispute</c>
        ///  <c>issuing_transaction</c>
        ///  <c>payment</c>
        ///  <c>payment_failure_refund</c>
        ///  <c>payment_refund</c>
        ///  <c>payout</c>
        ///  <c>payout_cancel</c>
        ///  <c>payout_failure</c>
